    ...
    const fetchReferDetails = async () => {
      try {
        ...
        if (data && data.length > 0) {
          // If FriendCode already exists, set it to input and disable editing
