...
const ServiceCard = ({ icon, label, onClick }) => {
  return (
    ...
    >
      <Card className="w-[110px] h-[110px] sm:w-[130px] sm:h-[130px] md:w-[90px] md:h-[90px] lg:w-[90px] lg:h-[90px] rounded-xl overflow-hidden border border-gray-100 bg-gradient-to-br from-white to-gray-50 shadow-lg group-hover:shadow-xl group-hover:-translate-y-1 transition-all duration-300">
...
const ServiceCardSection = ({ onServiceSelect }) => {
  ...
  return (
    <div className="w-full flex flex-col items-start sm:px-6 md:px-8 lg:px-12 font-sans bg-gray-50 py-1">
      <div className="w-full max-w-7xl">
        <div className="bg-white border border-gray-300 rounded-[8px] w-full py-6 px-4 sm:px-6 transition-all duration-300 ">
          <h3 className="text-lg text-start sm:text-xl md:text-2xl font-bold tracking-tight text-gray-900 mb-6 sm:mb-8 bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
          ...
          {loading ? (
            ...
            <div className="max-h-[300px] sm:max-h-[550px] overflow-y-auto scrollbar-thin scrollbar-thumb-indigo-200 scrollbar-track-gray-50 p-1 sm:p-5">
